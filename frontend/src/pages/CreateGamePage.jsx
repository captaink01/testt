      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div className="bg-white/25 backdrop-blur-3xl border border-white/40 rounded-3xl shadow-2xl ring-1 ring-white/20 p-8 md:p-12 transition-all duration-500">
          ...
          <form
            ...
            className={`space-y-8 ${loading || success ? "hidden" : ""}`}
          >
            {/* Sport Selection */}
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-6 py-5 bg-white/20 border border-white/50 rounded-2xl text-white placeholder-white/60 focus:outline-none focus:border-blue-400 focus:bg-white/30 focus:ring-4 focus:ring-blue-400/40 transition-all duration-300 backdrop-blur-sm shadow-inner text-lg"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="w-full px-6 py-5 bg-white/20 border border-white/50 rounded-2xl text-white placeholder-white/60 focus:outline-none focus:border-blue-400 focus:bg-white/30 focus:ring-4 focus:ring-blue-400/40 transition-all duration-300 backdrop-blur-sm shadow-inner text-lg resize-none"
                placeholder="Tell players about the game, skill level, vibe, etc..."
              />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  className="w-full px-6 py-5 bg-white/20 border border-white/50 rounded-2xl text-white focus:outline-none focus:border-blue-400 focus:bg-white/30 focus:ring-4 focus:ring-blue-400/40 transition-all duration-300 backdrop-blur-sm shadow-inner text-lg"
                />
              </div>
              <div>
                <label className="block text-xl font-bold text-white mb-3">
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-8">
              ...
              <button
                ...
                className="px-10 py-6 bg-white/15 backdrop-blur-sm border border-white/40 text-white font-bold rounded-2xl hover:bg-white/25 transform hover:-translate-y-1 transition-all duration-300 text-xl tracking-wide"
              >
                Cancel
              </button>
            </div>
