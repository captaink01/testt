      ...
      <main className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white/25 backdrop-blur-3xl border border-white/40 rounded-3xl shadow-2xl ring-1 ring-white/20 p-8 md:p-12 transition-all duration-500">
          ...
          <p className="text-xl text-white/80 font-medium mb-10 max-w-4xl">
            Choose the sports you love we'll connect you with players, games,
            and teams on campus.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-10">
            {allSports.map((sport) => (
              ...
              >
                ...
                />
                <div
                  className={`h-full min-h-40 bg-white/${
                    selectedSports.includes(sport.id) ? "30" : "15"
                  } backdrop-blur-sm border ${
                    selectedSports.includes(sport.id)
                      ? "border-blue-400/60"
                      : "border-white/40"
                  } rounded-3xl p-6 flex flex-col items-center justify-center gap-4 transition-all duration-500 group-hover:bg-white/30 group-hover:scale-105`}
                >
